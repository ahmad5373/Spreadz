    ...
    return (
        <div className="flex flex-col bg-gray-100  pt-12 w-full">
            ...
            <div className="flex flex-col space-y-8 mt-8">
                ...
                <div className="flex flex-col lg:flex-row gap-4 bg-white p-4 rounded-lg">
                    <div className="relative flex flex-col justify-end p-4 w-full lg:w-[756px] h-[300px] lg:h-[498px] bg-left rounded-lg text-white">
                        <h1 className="base-font-heading text-3xl ">Heading</h1>
                        ...
                        <p className="mt-4 base-font text-lg">
            ...
            <div className="flex flex-col mt-20 mb-8">
                ...
                <div className="mt-16 grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                    <div className="flex justify-between">
                        <div className="lg:w-[404px] flex flex-col">
                            <div className="bg-post h-[303.457px] rounded-xl"></div>
                            <div><p className="base-font-heading text-2xl my-4">Aenean eleifend ante maecenas</p></div>
